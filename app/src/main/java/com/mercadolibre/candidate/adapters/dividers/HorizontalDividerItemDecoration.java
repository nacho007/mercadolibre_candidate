...
import static com.mercadolibre.candidate.adapters.dividers.FlexibleDividerDecoration.Builder.mPositionInsideItem;
...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        Builder margin(final int leftMargin, final int rightMargin) {
