package com.mercadolibre.candidate.adapters.dividers;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class Builder<T extends Builder> {
        ...
        static boolean mPositionInsideItem = false;
        ...
        private T paintProvider(PaintProvider provider) {
            mPaintProvider = provider;
            return (T) this;
        }

        T color(final int color) {
        ...
        private T colorProvider(ColorProvider provider) {
        ...
        private T sizeProvider(SizeProvider provider) {
